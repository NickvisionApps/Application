...
public class MainWindowController : IDisposable
{
    ...
    public string Greeting => DateTime.Now.Hour switch
    {
        ...
        _ => _services.Get<ITranslationService>()!._("Good Day!"),
    };
    ...
    public string GetDebugInformation(string extraInformation) => Environment.GetDebugInformation(AppInfo, $"{CultureInfo.CurrentCulture}\n{extraInformation}");
