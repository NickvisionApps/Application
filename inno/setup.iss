...
AppId={{27998EA7-C64D-4010-B909-6A6D3C5B62A6}
AppName={#MyAppName}
...
Source: "..\out-windows\org.nickvision.application.winui\Release\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion 
Source: "..\out-windows\org.nickvision.application.winui\Release\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
