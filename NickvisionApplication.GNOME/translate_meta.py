...
resx_dir = (script_dir / '../NickvisionApplication.Shared/Resources/').resolve()
...
with open(f'{install_prefix}/share/applications/org.nickvision.application.desktop', 'r') as f:
...
for i in range(len(contents)):
    if contents[i].startswith('Comment='):
        ...
        j += 1
    j += 1
with open(f'{install_prefix}/share/applications/org.nickvision.application.desktop', 'w') as f:
    new_contents = "".join(new_contents)
    f.write(new_contents)

with open(f'{install_prefix}/share/metainfo/org.nickvision.application.metainfo.xml', 'r') as f:
    contents = f.readlines()
    new_contents = contents.copy()
j = 0
for i in range(len(contents)):
    if contents[i].find('<summary>') > -1:
        ...
        break
    j += 1
with open(f'{install_prefix}/share/metainfo/org.nickvision.application.metainfo.xml', 'w') as f:
    new_contents = "".join(new_contents)
    f.write(new_contents)]
