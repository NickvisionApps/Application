...
namespace Nickvision::Application::Qt::Views
{
    ...
    void MainWindow::onFolderChanged(const EventArgs& args)
    {
        ...
        {
            m_ui->lblFiles->setText(QString::fromStdString(_fn("There is {} file in the folder.", "There are {} files in the folder.", m_controller->getFiles().size(), m_controller->getFiles().size())));
