...
namespace Nickvision::Application::Qt::Controls
{
        ...
        m_debugInformation{ QString::fromStdString(debugInformation) }
    {
        ...
        m_ui->lblAppIcon->setPixmap({ appInfo.getVersion().getVersionType() == VersionType::Stable ? ":/resources/org.nickvision.application.svg" : ":/resources/org.nickvision.application-devel.svg" });
