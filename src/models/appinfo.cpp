...
void AppInfo::generateTranslatorCredits()
{
    ...
    std::string path;
    if(std::filesystem::exists("/usr/share/org.nickvision.application/CREDITS.json"))
    {
        path = "/usr/share/org.nickvision.application/CREDITS.json";
    }
    else if(std::filesystem::exists("/app/share/org.nickvision.application/CREDITS.json"))
    {
        path = "/app/share/org.nickvision.application/CREDITS.json";
    }
    else
    {
        path = "CREDITS.json";
