...
import {Field, FieldContent, FieldGroup, FieldTitle} from "@/components/ui/field.tsx";
        ...
        <div className="flex h-72 min-h-0 gap-4">
          <div className="flex w-32 shrink-0 flex-col gap-1">
            {sections.map((section) => (
              <Button key={section.page} variant={page === section.page ? "secondary" : "ghost"}
                      className="justify-start" onClick={() => setPage(section.page)}>
                <section.icon/>
            ...
            {page === "general" && (
              <FieldGroup className="p-1">
                <Field orientation="horizontal">
                  ...
                  <Select items={themeOptions} value={configuration.theme} onValueChange={(value) => {
                    if (value !== null) {
                      setConfiguration({
                        ...configuration,
                        theme: value
                ...
                <Field orientation="horizontal">
                  ...
                  <Select value={configuration.translationLanguage} onValueChange={(value) => {
                    if (value !== null) {
                      setConfiguration({
                        ...configuration,
            ...
            {page === "advanced" && (
              <FieldGroup className="p-1">
                <Field orientation="horizontal">
                  ...
                  <Switch checked={configuration.allowPreviewUpdates} onCheckedChange={(checked) => {
                    setConfiguration({
                      ...configuration,
