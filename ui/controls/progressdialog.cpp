...
ProgressDialog::ProgressDialog(GtkWidget* parent, const std::string& description, const std::function<void()>& work, const std::function<void()>& then) : Widget{"/org/nickvision/application/ui/controls/progressdialog.xml", "adw_progDialog"}, m_work{work}, m_then{then}, m_isFinished{false}
{
    //==Dialog==//
