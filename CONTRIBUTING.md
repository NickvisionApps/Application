...
- Collect information about the bug:
  - Debug information provided by the application
    - WinUI: open Help → About Application, click on the button with version number, debug information will be copied to clipboard.
...
| Command | Result |
|---|---|
| `just run` | Builds the application in a temporary build directory and runs it. Application will not get installed, which might result in some missing icons and lack of desktop integration. |
