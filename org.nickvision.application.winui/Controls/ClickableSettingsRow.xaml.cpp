...
{
    DependencyProperty ClickableSettingsRow::m_glyphProperty = DependencyProperty::Register(L"Glyph", winrt::xaml_typename<winrt::hstring>(), winrt::xaml_typename<Nickvision::Application::WinUI::Controls::ClickableSettingsRow>(), PropertyMetadata{ winrt::box_value(L""), PropertyChangedCallback{ &ClickableSettingsRow::OnPropertyChanged } });
    ...
    DependencyProperty ClickableSettingsRow::m_childProperty = DependencyProperty::Register(L"Child", winrt::xaml_typename<IInspectable>(), winrt::xaml_typename<Nickvision::Application::WinUI::Controls::ClickableSettingsRow>(), PropertyMetadata{ nullptr, PropertyChangedCallback{ &ClickableSettingsRow::OnPropertyChanged } });
    ...
    {
        if(Nickvision::Application::WinUI::Controls::ClickableSettingsRow settingsRow{ d.try_as<Nickvision::Application::WinUI::Controls::ClickableSettingsRow>() })
        {
