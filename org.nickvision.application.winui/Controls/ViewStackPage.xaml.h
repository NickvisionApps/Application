...
namespace winrt::Nickvision::Application::WinUI::Controls::implementation 
{
    ...
    public:
         ...
         */
        winrt::hstring PageName() const noexcept;
        /**
         * @brief Sets the name of this page.
         * @param pageName The new name of the page 
         */
        void PageName(const winrt::hstring& pageName) noexcept;
    ...
    public:
         ...
         */
        static const Microsoft::UI::Xaml::DependencyProperty& PageNameProperty() noexcept;
