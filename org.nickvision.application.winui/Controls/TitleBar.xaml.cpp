...
namespace winrt::Nickvision::Application::WinUI::Controls::implementation
{
    ...
    DependencyProperty TitleBar::m_isActivatedProperty = DependencyProperty::Register(L"IsActivated", winrt::xaml_typename<bool>(), winrt::xaml_typename<Nickvision::Application::WinUI::Controls::TitleBar>(), PropertyMetadata{ winrt::box_value(true), PropertyChangedCallback{ &TitleBar::OnPropertyChanged } });
    ...
    {
        if(Nickvision::Application::WinUI::Controls::TitleBar titleBar{ d.try_as<Nickvision::Application::WinUI::Controls::TitleBar>() })
        {
